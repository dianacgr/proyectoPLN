...
def init_corenlp_command(corenlp_path, memory, properties):
    ...
    jars = ["stanford-corenlp-?.?.?.jar",
            ...
            #~ "stanford-corenlp-?.?.?-models-spanish.jar",
            "xom.jar",
            "joda-time.jar",
            "jollyday.jar",
...
def parse_xml_output(input_dir, corenlp_path=DIRECTORY, memory="1000m", raw_output=False, properties='default.properties'):
...
class StanfordCoreNLP:
    ...
    def __init__(self, corenlp_path=DIRECTORY, memory="1000m", properties='default.properties', serving=False):
        """
        Checks the location of the jar files.
        Spawns the server as a process.
        """
...
def batch_parse(input_folder, corenlp_path=DIRECTORY, memory="1000m", raw_output=False):
    """
...
def main():
    ...
    try:
        ...
        nlp = StanfordCoreNLP(options.corenlp, memory="1000m" ,properties=options.properties, serving=True)
